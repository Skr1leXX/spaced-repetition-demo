...
const DashboardPage = () => {
  ...
  const quickActions = [
    { 
      ...
      description: 'Повторить карточки по алгоритму', 
      icon: Brain, 
      path: '/study', 
      color: 'bg-blue-500' 
    },
    { 
      title: 'Создать курс', 
      description: 'Добавить новые слова для изучения', 
      icon: Plus, 
      path: '/decks/new', 
      color: 'bg-green-500' 
    },
    { 
      ...
      description: 'Расширить существующие колоды', 
      icon: BookOpen, 
      path: '/decks', 
      color: 'bg-purple-500' 
    },
    { 
      ...
      description: 'Анализ вашего прогресса', 
      icon: BarChart3, 
      path: '/stats', 
      color: 'bg-yellow-500' 
    },
  ...
  const leitnerMethodSteps = [
    {
      icon: Layers,
      title: 'Карточки в 5 уровнях',
      description: 'Все карточки распределены по 5 уровням в зависимости от вашего знания'
    },
    {
      icon: Repeat,
      title: 'Интервалы повторения',
      description: 'Чем выше уровень - тем реже повторение. Уровень 1: каждый день, Уровень 5: раз в месяц'
    },
    {
      icon: CheckCircle,
      title: 'Прогресс через ответы',
      description: 'Правильный ответ - карточка переходит на уровень выше. Ошибка - возвращается на уровень 1'
    },
    {
      icon: ChevronsRight,
      title: 'Автоматический расчет',
      description: 'Система автоматически рассчитывает когда показывать каждую карточку'
    }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* НОВЫЙ БЛОК: Как работает метод Лейтнера */}
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-blue-700 mt-2">
              Ваш прогресс управляется системой интервального повторения, которая увеличивает интервалы между повторениями 
              для хорошо изученных карточек и сокращает их для тех, которые вы забываете.
            </p>
          </div>
          <Link 
            to="/about/method"
        ...
        <div className="mt-6 pt-6 border-t border-blue-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-blue-800">
            <div className="flex items-center">
              ...
              <span>Карточки перемещаются между курсами в зависимости от ваших ответов</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-blue-500 rounded-full mr-2"></div>
              <span>Чем лучше знаете — тем реже повторяете</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-purple-500 rounded-full mr-2"></div>
              <span>Автоматический расчёт оптимального времени повторения</span>
            </div>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {deck.card_count || 0} карточек • {deck.due_count || 0} к повторению
                    </p>
                  </div>
                </div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-sm text-gray-500">
              Карточек в {decks.length} курсах
            </div>
          </div>
        </div>

        {/* Статистика за неделю и советы */}
